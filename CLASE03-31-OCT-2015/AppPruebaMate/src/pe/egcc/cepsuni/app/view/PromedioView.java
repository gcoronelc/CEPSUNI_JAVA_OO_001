...
public class PromedioView extends javax.swing.JFrame {
  ...
  private void agregarPaneles(){
    panelContenedor.add("PROMEDIO 2", new Promedio2View());
    panelContenedor.add("PROMEDIO 3", new Promedio3View());
    panelContenedor.add("PROMEDIO 4", new Promedio4View());
    panelContenedor.add("PROMEDIO 5", new Promedio5View());
  }
  ...
  private void initComponents() {
    ...
    layout.setHorizontalGroup(
      ...
      .addComponent(panelContenedor, javax.swing.GroupLayout.DEFAULT_SIZE, 483, Short.MAX_VALUE)
    );
    layout.setVerticalGroup(
      layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addComponent(panelContenedor, javax.swing.GroupLayout.DEFAULT_SIZE, 412, Short.MAX_VALUE)
    );
